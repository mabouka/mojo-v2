<?php get_header(); ?>
<div class="view singleCase"  data-barba="container" data-barba-namespace="singlecase" data-page-css="<?= getUrlVersion('dist/css/page-single-case.css') ?>" data-blocks="true" <?= get_field('color') ? ' style="--pagecolor:' . get_field('color') . ';"' : '' ?> >

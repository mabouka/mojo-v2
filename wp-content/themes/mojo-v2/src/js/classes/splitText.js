export default class SplitText {
	constructor(element, options) {
		...
		if (!this.options.hasOwnProperty("words")) this.options.words = 1;
		if (!this.options.hasOwnProperty("chars")) this.options.chars = 1;
		if (!this.options.hasOwnProperty("spacing")) this.options.spacing = 5;
	...
	splitTextNodes = function (textNodes) {

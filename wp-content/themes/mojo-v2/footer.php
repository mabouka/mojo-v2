...
<script>
/* CSS chunks are loaded statically by PHP via <link> tags — pre-mark them as
   fulfilled so webpack's entry callback isn't blocked waiting for them.
   Generated by PreFulfillCssChunks plugin (webpack.mix.js). */
(self.webpackChunkmojo_agency=self.webpackChunkmojo_agency||[]).push([
  ["css/page-single-case","css/page-cases","css/page-home","css/base","css/main",
   "css/blocks/imagesslider/imagesslider","css/blocks/fullimage/fullimage",
   "css/blocks/fullblackimage/fullblackimage","css/blocks/textgallery/textgallery",
   "css/blocks/textimage/textimage","css/blocks/quoteimage/quoteimage",
   "css/blocks/twoimages/twoimages","css/page-misc","css/page-stories","css/page-lead",
   "css/page-commitments","css/page-clients","css/page-about","css/page-service-child",
   "css/page-service-parent","css/page-services-archive"],
  {}
]);
</script>
...
<?php // TEMPORARY : cookie consent OFF pour bench Lighthouse. À ré-activer avant prod réelle. ?>
<?php // <script defer src="<?= getUrlVersion('dist/js/cookieconsent-config.js'); ?>"></script> ?>
<!-- LinkedIn Insight Tag — commenté temporairement (cookies tiers + deprecations API)
<script type="text/javascript"> _linkedin_partner_id = "6766820"; window._linkedin_data_partner_ids = window._linkedin_data_partner_ids || []; window._linkedin_data_partner_ids.push(_linkedin_partner_id); </script><script type="text/javascript"> (function(l) { if (!l){window.lintrk = function(a,b){window.lintrk.q.push([a,b])}; window.lintrk.q=[]} var s = document.getElementsByTagName("script")[0]; var b = document.createElement("script"); b.type = "text/javascript";b.async = true; b.src = "https://snap.licdn.com/li.lms-analytics/insight.min.js"; s.parentNode.insertBefore(b, s);})(window.lintrk); </script> <noscript> <img height="1" width="1" style="display:none;" alt="" src="https://px.ads.linkedin.com/collect/?pid=6766820&fmt=gif" /> </noscript>
-->

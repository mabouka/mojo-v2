...
<head>
    ...
    <link rel="preload" href="<?= getUrl('mojo-v2/dist/images/homeIntroStars.svg'); ?>" fetchpriority="high" as="image" type="image/svg+xml">
    <?php endif ?>
        ...
        <div class="wrapper">
            <div class="header__inside">
                ...
                <a href="#menu" class="header__menu openMenu" title="<?= __("Menu", "mj") ?>" data-cursor-stick>
                    ...
                    <svg class="header__menuSvg" width="24" height="22" viewBox="0 0 23.984 21.4">

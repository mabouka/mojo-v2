"use strict";
(self["webpackChunkmojo_agency"] = self["webpackChunkmojo_agency"] || []).push([["wp-content_themes_mojo-v2_src_js_components_serviceGrid_js"],{
...
var ServiceGrid = /*#__PURE__*/function () {
  function ServiceGrid(el) {
    ...
    if (this.intro) {
      ...
      var elapsed = window.__barbaEnterStart ? Date.now() - window.__barbaEnterStart : 0;
      var remaining = Math.max(0, 600 - elapsed);
      (0,_utils_wait__WEBPACK_IMPORTED_MODULE_1__["default"])(remaining).then(function () {
...
//# sourceMappingURL=wp-content_themes_mojo-v2_src_js_components_serviceGrid_js.js.map
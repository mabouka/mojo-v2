...
/* harmony import */ var _IsCentered__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../IsCentered */ "./wp-content/themes/mojo-v2/src/js/classes/IsCentered.js");
/* harmony import */ var _IsTop__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../IsTop */ "./wp-content/themes/mojo-v2/src/js/classes/IsTop.js");
/* harmony import */ var _Menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Menu */ "./wp-content/themes/mojo-v2/src/js/classes/Menu.js");
/* harmony import */ var _utils_video__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/video */ "./wp-content/themes/mojo-v2/src/js/classes/Router/utils/video.js");
/* harmony import */ var _transitions_curtain__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./transitions/curtain */ "./wp-content/themes/mojo-v2/src/js/classes/Router/transitions/curtain.js");
/* harmony import */ var _transitions_curtainFade__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./transitions/curtainFade */ "./wp-content/themes/mojo-v2/src/js/classes/Router/transitions/curtainFade.js");
/* harmony import */ var _transitions_fade__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./transitions/fade */ "./wp-content/themes/mojo-v2/src/js/classes/Router/transitions/fade.js");
/* harmony import */ var _views_contact__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./views/contact */ "./wp-content/themes/mojo-v2/src/js/classes/Router/views/contact.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var Router = /*#__PURE__*/function () {
  function Router() {
    ...
    _barba_core__WEBPACK_IMPORTED_MODULE_0___default().init({
      ...
      transitions: [
      //curtainFade,
      _transitions_curtain__WEBPACK_IMPORTED_MODULE_6__["default"], _transitions_fade__WEBPACK_IMPORTED_MODULE_8__["default"]],
      views: [_views_contact__WEBPACK_IMPORTED_MODULE_9__["default"]
      //singlecase,
      //singleservicechild,
      //pageTemplate
      ]
    ...
    _barba_core__WEBPACK_IMPORTED_MODULE_0___default().hooks.afterLeave(function () {
      _Menu__WEBPACK_IMPORTED_MODULE_4__["default"].closeQuick();
    });
    ...
    _barba_core__WEBPACK_IMPORTED_MODULE_0___default().hooks.beforeEnter(function (data) {
      ...
      _Menu__WEBPACK_IMPORTED_MODULE_4__["default"].update(data);
      gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_10__.ScrollTrigger.killAll();
    ...
    _barba_core__WEBPACK_IMPORTED_MODULE_0___default().hooks.enter(function (data) {
      ...
      _IsTop__WEBPACK_IMPORTED_MODULE_3__["default"].addView(data.next.container);
      _IsCentered__WEBPACK_IMPORTED_MODULE_2__["default"].addView(data.next.container);
      document.documentElement.classList.remove('loading');
    });
    _barba_core__WEBPACK_IMPORTED_MODULE_0___default().hooks.afterEnter(function (data) {
      (0,_utils_video__WEBPACK_IMPORTED_MODULE_5__.forceAutoplay)(data);
      setTimeout(function () {
        window.lenis.resize();
        gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_10__.ScrollTrigger.refresh();
      }, 200);
...
var LazyVideos = /*#__PURE__*/function () {
  function LazyVideos() {
    ...
    if ("IntersectionObserver" in window) {
      ...
      this.lazyVideos.forEach(function (lazyVideo) {
        _this.lazyVideoObserver.observe(lazyVideo);
      });
    }
  }
  _createClass(LazyVideos, [{
    key: "callback",
    value: function callback(entries, observer) {
      var _this2 = this;
      entries.forEach(function (video) {
        if (video.isIntersecting) {
          _this2.loadVideo(video);
        }
      });
    }
  }, {
...
var caseCard = /*#__PURE__*/function () {
  function caseCard(el) {
    ...
    if (_utils_detect__WEBPACK_IMPORTED_MODULE_1__.isMobile) {
...
var HomeIntro = /*#__PURE__*/function () {
  function HomeIntro(el) {
    ...
    if (window.homeAnimationDone === undefined) {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(this.moon, {
        autoAlpha: 1,
        scale: 1,
        x: 0,
        rotate: 0,
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(this.poly, {
        x: 0,
        rotate: 0,
        duration: 1.2,
        ease: "power3.out"
  ...
  _createClass(HomeIntro, [{
    ...
    key: "launchScroll",
    value: function launchScroll() {
      this.main = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline({
        scrollTrigger: {
          trigger: this.el,
          start: '+=1',
          scrub: true,
...
var HomePurpose = /*#__PURE__*/function () {
  function HomePurpose(el) {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].ticker.add(this.frame.bind(this));
    this.setRect();
    this.setEvents();
  }
  _createClass(HomePurpose, [{
    ...
    value: function frame() {
      gsap__WEBPACK_IMPORTED_MODULE_1__["default"].to('#purposeSvg_circle', {
    ...
    value: function setEvents() {
      ...
      if ((0,_utils_detect__WEBPACK_IMPORTED_MODULE_0__.isMouse)()) {
        this.sensible.addEventListener('mouseenter', this.e_mousenter.bind(this));
        this.sensible.addEventListener('mouseleave', this.e_mouseleave.bind(this));
        this.links.forEach(function (link) {
          link.addEventListener('mouseenter', _this.e_mousenterLink.bind(_this));
      ...
      if ((0,_utils_detect__WEBPACK_IMPORTED_MODULE_0__.isFirefox)()) {
        //quickfix firefox
        gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set('#purposeSvg_circle', {
          autoAlpha: 0,
          scale: 0.001
        });
        this.el.addEventListener('mouseenter', this.e_mousenterEl.bind(this));
...
var HomeService = /*#__PURE__*/function () {
  function HomeService(el) {
    ...
    if (!(0,_utils_detect__WEBPACK_IMPORTED_MODULE_0__.isMobile)()) {
      this.initIntro();
      this.initScroller();
    } else {
      this.initSwiper();
...
var homeTransformation = /*#__PURE__*/function () {
  function homeTransformation(el) {
    ...
    if ((0,_utils_detect__WEBPACK_IMPORTED_MODULE_0__.isFirefox)()) return;
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].registerPlugin(gsap_MotionPathPlugin__WEBPACK_IMPORTED_MODULE_2__.MotionPathPlugin, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger);
    this.el = el;
  ...
  _createClass(homeTransformation, [{
    ...
    value: function setPos() {
      gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set(this.circle, {
        scale: 0.2
      });
      gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set(this.circle, {
        autoAlpha: 0
    ...
    key: "initScroller",
    value: function initScroller() {
      this.main = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
        scrollTrigger: {
          trigger: this.el,
          start: 'top-=400',
          end: '+=100%',
...
/* harmony import */ var _classes_lazyVideos__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./classes/lazyVideos */ "./wp-content/themes/mojo-v2/src/js/classes/lazyVideos.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var Mojo = /*#__PURE__*/function () {
  ...
  _createClass(Mojo, [{
    ...
    value: function setupElements() {
      ...
      this.LazyVideos = new _classes_lazyVideos__WEBPACK_IMPORTED_MODULE_10__["default"]();
    }
  }]);
  return Mojo;
}();

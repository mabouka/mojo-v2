"use strict";
(self["webpackChunkmojo_agency"] = self["webpackChunkmojo_agency"] || []).push([["wp-content_themes_mojo-v2_src_js_components_homeService_js"],{
...
var HomeService = /*#__PURE__*/function () {
  ...
  return _createClass(HomeService, [{
    ...
    value: function initScroller() {
      var _this = this;
      var getScrollDistance = function getScrollDistance() {
        return Math.max(_this.realSection.offsetWidth - _this.container.offsetWidth, 0);
      };
      ...
      this.main = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
        scrollTrigger: {
          ...
          start: 'top',
            ...
            return "+=".concat(getScrollDistance());
          },
          scrub: true,
          pin: this.pin,
...
//# sourceMappingURL=wp-content_themes_mojo-v2_src_js_components_homeService_js.js.map
        ...
        <div class="casesGrid__inside">
            <div class="casesGrid__filters">
                ...
                <div class="casesGrid__filter">
                    <a class="casesGrid__filterLink" href=""><?= __('Sectors', 'mj'); ?></a>
                    <svg class="casesGrid__star" width="15" height="15">
                        <use xlink:href="#star"></use>
                    </svg>
                </div>

                <div class="casesGrid__filter">
                    <a class="casesGrid__filterLink" href=""><?= __('Territories', 'mj'); ?></a>
                    <svg class="casesGrid__star" width="15" height="15">
                        <use xlink:href="#star"></use>
                    </svg>
                </div>
                ...
                <div class="casesGrid__filter">
                    <a class="casesGrid__filterLink" href=""><?= __('Clients', 'mj'); ?></a>
                    <svg class="casesGrid__star" width="15" height="15">
                        <use xlink:href="#star"></use>
                    </svg>
                </div>
                ...
                <div class="casesGrid__filter">
                    <a class="casesGrid__filterLink" href=""><?= __('Services', 'mj'); ?></a>
                    <svg class="casesGrid__star" width="15" height="15">
                        <use xlink:href="#star"></use>
                    </svg>
                </div>
